...
Ecosystem: Nexus, Amplication, Prisma Platform (cloud). DB modelling is not fully agnostic, there're a lot of differences between Mongo and SQL dialects and even some stupid [limitations](https://github.com/prisma/prisma/issues/2219).
