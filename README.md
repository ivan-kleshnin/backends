...
- [NHost](https://nhost.io/) is built on top of Hasura, Hasura-Auth and S3. No self-hosting option. URQL support is not documented [a.t.m](https://issuehint.com/issue/nhost/nhost/271)
